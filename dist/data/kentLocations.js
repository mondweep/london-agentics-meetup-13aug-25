...
exports.POPULAR_ROUTES = exports.LOCATION_CATEGORIES = exports.DEMO_TRIPS = exports.KENT_TRAFFIC_PATTERNS = exports.KENT_ROUTES = exports.KENT_LOCATIONS = void 0;
exports.KENT_LOCATIONS = [
    {
...
exports.DEMO_TRIPS = [
    {
        ...
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Bradbourne Vale Road (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Kumon Math Centre Sevenoaks'),
        persona: 'Alex',
        schedule: { days: [2, 4], windowStart: '16:30', windowEnd: '17:00' },
        alertThreshold: { type: 'MINUTES', value: 8 }
    },
    {
        name: 'School Drop-off (Knole Academy)',
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Bradbourne Vale Road (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Knole Academy'),
        persona: 'Alex',
    ...
    },
    {
        ...
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Bradbourne Vale Road (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Bluewater Shopping Centre'),
        persona: 'Alex',
        schedule: { days: [6], windowStart: '10:00', windowEnd: '11:00' },
        alertThreshold: { type: 'PERCENTAGE', value: 30 }
    },
    {
        name: 'London Commute',
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Rusthall Common (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Tunbridge Wells Central Station'),
        persona: 'Chloe',
        schedule: { days: [1, 2, 3, 4, 5], windowStart: '07:45', windowEnd: '08:00' },
        alertThreshold: { type: 'MINUTES', value: 10 }
    },
    {
        name: 'Client Meeting (Sevenoaks)',
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Rusthall Common (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Sevenoaks High Street'),
        persona: 'Chloe',
        schedule: { days: [3], windowStart: '14:00', windowEnd: '14:30' },
        alertThreshold: { type: 'MINUTES', value: 15 }
    },
    {
        name: 'Hospital Appointment',
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Rusthall Common (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Tunbridge Wells Hospital'),
        persona: 'Chloe',
        schedule: { days: [1], windowStart: '09:15', windowEnd: '09:30' },
        alertThreshold: { type: 'MINUTES', value: 12 }
    },
    {
        name: 'Grammar School Drop-off',
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Kippington Gardens (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Tunbridge Wells Grammar School for Boys'),
        persona: 'James',
    ...
    },
    {
        ...
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Riverhead Village (Residential)'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Ebbsfleet International Station'),
        persona: 'James',
    ...
    },
    {
        ...
        origin: exports.KENT_LOCATIONS.find(l => l.name === 'Sevenoaks High Street'),
        destination: exports.KENT_LOCATIONS.find(l => l.name === 'Canterbury Cathedral'),
        persona: 'Alex',
        schedule: { days: [0], windowStart: '09:00', windowEnd: '10:00' },
        alertThreshold: { type: 'MINUTES', value: 20 }
    }
];
exports.LOCATION_CATEGORIES = {
    SCHOOLS: exports.KENT_LOCATIONS.filter(l => l.type === 'school'),
    STATIONS: exports.KENT_LOCATIONS.filter(l => l.type === 'station'),
    SHOPPING: exports.KENT_LOCATIONS.filter(l => l.type === 'commercial'),
    HEALTHCARE: exports.KENT_LOCATIONS.filter(l => l.type === 'healthcare'),
    RESIDENTIAL: exports.KENT_LOCATIONS.filter(l => l.type === 'residential')
};
exports.POPULAR_ROUTES = {
    SEVENOAKS_TO_LONDON: {
...
//# sourceMappingURL=kentLocations.js.map