...
const tripService_1 = require("../../src/services/tripService");
describe('TripService', () => {
    let tripService;
    beforeEach(() => {
        tripService = new tripService_1.TripService();
    });
    describe('Trip Creation', () => {
        ...
        it('should create a new trip successfully', async () => {
            ...
            const trip = await tripService.createTrip(userId, validTripData.name, validTripData.origin, validTripData.destination, validTripData.schedule, validTripData.alertThreshold);
        ...
        it('should retrieve trip by ID', async () => {
            const userId = 'user123';
            const createdTrip = await tripService.createTrip(userId, validTripData.name, validTripData.origin, validTripData.destination, validTripData.schedule, validTripData.alertThreshold);
        ...
        it('should retrieve all trips for a user', async () => {
            ...
            const trip1 = await tripService.createTrip(userId, 'Trip 1', validTripData.origin, validTripData.destination, validTripData.schedule, validTripData.alertThreshold);
            const trip2 = await tripService.createTrip(userId, 'Trip 2', validTripData.destination, validTripData.origin, validTripData.schedule, validTripData.alertThreshold);
    ...
    describe('Trip Management', () => {
        ...
        beforeEach(async () => {
            testTrip = await tripService.createTrip(userId, 'Test Trip', {
                latitude: 51.2719,
                longitude: 0.1904,
                address: 'Sevenoaks High Street, Kent'
            }, {
    ...
    describe('Active Trips for Monitoring', () => {
        beforeEach(async () => {
            await tripService.createTrip('user1', 'Monday Trip', {
                latitude: 51.2719,
                longitude: 0.1904,
                address: 'Origin'
            }, {
            ...
            await tripService.createTrip('user2', 'Weekday Trip', {
                latitude: 51.2719,
                longitude: 0.1904,
                address: 'Origin'
            }, {
        ...
        it('should find active trips for monitoring on correct day and time', async () => {
            const mondayMorning = new Date(2024, 0, 8, 7, 35);
...
//# sourceMappingURL=tripService.test.js.map